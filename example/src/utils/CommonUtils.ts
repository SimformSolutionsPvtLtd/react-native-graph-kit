import type { ChartDataType } from 'react-native-graph-kit';
 ...
 * @returns {ChartDataType} - An object containing dummy data in the specified format.
 */
export function generateDummyData(numElements: number): ChartDataType {
